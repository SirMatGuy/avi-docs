    ...
    <div className="max-w-4xl py-10 lg:py-14 mx-auto">
      ...
      <div className="relative  xl:mx-auto">
        ...
        <div className="grid grid-cols-1  gap-6 lg:gap-8">
          <div className="">
            {/* Card */}
            <div className="z-50 relative rounded-xl group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 dark:bg-black dark:border-white/[0.2] bg-white border border-transparent justify-between flex flex-col space-y-4">
