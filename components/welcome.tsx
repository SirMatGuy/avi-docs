    ...
    return (
        ...
        <div className="mx-auto max-w-4xl min-w-0 space-y-2 mb-10">
            <div className="mb-8 lg:mb-14 ">
                <h2 className="scroll-m-20 mb-4 text-4xl font-bold tracking-tight text-black dark:text-white">Simplify your ML workflow, <span className="dark:text-indigo-400 text-indigo-500 ">maximize your impact</span>.
