    ...
    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
      ...
      <div className="mt-5 max-w-2xl text-center mx-auto">
        <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-neutral-200">
          Let's Build {" "}
          <span className="bg-clip-text bg-gradient-to-tl from-indigo-600 to-purple-600 text-transparent">
            Together
          </span>
        </h1>
      </div>
      ...
      <div className="mt-5 max-w-3xl text-center mx-auto">
        <p className="text-lg text-gray-600 dark:text-neutral-400">
          Don't waste time on building pipelines, make your data matter now.
        </p>
      </div>
      {/* Buttons */}
      <div className="mt-8 gap-3 flex justify-center">
        <a
          ...
          href="https://fastml.lemonsqueezy.com/buy/6ae13a25-4014-4be2-8ce9-d5aaf817e71a?enabled=391880&checkout[discount_code]=LAUNCH"
        >
          Get started
          <svg
            className="flex-shrink-0 size-4"
