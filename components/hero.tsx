  ...
  return (
    <div className="mb-10 lg:mb-20">
      <HeroHighlight className="space-y-12 ">
        <div className="text-2xl px-4 md:text-4xl lg:text-5xl inline-flex flex-col items-center justify-start font-bold text-neutral-700 dark:text-white  max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto ">
          <span className="inline-flex gap-2">

            Build{" "}
            <span className="text-indigo-400 ">
              <WordRotate className="" words={words} />
            </span>
          </span>
